...
public class GameManager : MonoBehaviour
{
    ...
    public void GameOver(bool isTimeOver, bool isCat = false)
    {
        ...
        finalPrice = Mathf.FloorToInt(score * 0.1f);
    ...
    public void EndGame()
    {
        ...
        finalPrice = Mathf.FloorToInt(score * 0.1f); // 얻을 골드 체크
        resultScoreText.text = Mathf.FloorToInt(score).ToString(); //최종 점수를 텍스트에 적어줌
